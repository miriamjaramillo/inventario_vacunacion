...
public class EmpleadoVacuna implements Serializable {
	...
	public EmpleadoVacuna(EmpleadoVacunaId id, Empleado empleado, Vacuna vacuna, Date fechaVacunacion, int numeroDosis) {
		this.id = new EmpleadoVacunaId(empleado.getEmpleadoId(), vacuna.getVacunaId(), numeroDosis);
